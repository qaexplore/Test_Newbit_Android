...
import com.spark.otcbitrade.activity.feed.FeedbackActivity;
...
public class AboutUsActivity extends BaseActivity implements com.spark.otcbitrade.activity.aboutus.AboutUsContract.View {
    ...
    private com.spark.otcbitrade.activity.aboutus.AboutUsPresenter presenter;
    ...
    protected void initData() {
        super.initData();
        presenter = new com.spark.otcbitrade.activity.aboutus.AboutUsPresenter(this);
    }
